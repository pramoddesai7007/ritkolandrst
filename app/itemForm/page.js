...
const capitalizeFirstLetter = (str) => {
    ...
    if (name === "unit") {
      ...
      try {
        const unitDetailsResponse = await axios.get(
          `https://absback1.vercel.app/api/unit/units/${value}`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (itemToEdit) {
        ...
        await axios.put(
          `https://absback1.vercel.app/api/item/items/${itemToEdit._id}`,
          formData
        );
      } else {
        // If creating, make a POST request
        await axios.post("https://absback1.vercel.app/api/item/items", {
          ...formData,
  ...
  const handleDeleteConfirmed = async () => {
    try {
      ...
      await axios.delete(
        `https://absback1.vercel.app/api/item/items/${itemIdToDelete}`
      );
  ...
  //     await axios.delete(`https://absback1.vercel.app/api/item/items/${itemId}`);
  ...
  return (
    <>
      <Navbar />
      <div className="container mx-auto mt-10 p-4 shadow-md rounded-md">
