...
const TasteList = () => {
  ...
  useEffect(() => {
    const fetchTastes = async () => {
      try {
        const response = await axios.get('https://absback1.vercel.app/api/taste/tastes');
...
//   ********
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch(`https://absback1.vercel.app/api/taste/tastes/${selectedTaste._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      ...
      await axios.delete(`https://absback1.vercel.app/api/taste/tastes/${selectedTaste._id}`);
...
// ***********
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://absback1.vercel.app/api/taste/tastes', { taste: newTaste });
