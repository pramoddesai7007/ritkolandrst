...
const Section = () => {
  ...
  useEffect(() => {
    const fetchSections = async () => {
      try {
        const response = await axios.get("https://absback1.vercel.app/api/section");
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      await axios.patch(
        `https://absback1.vercel.app/api/section/${sectionToEdit._id}`,
        {
  ...
  const handleDeleteConfirmed = async () => {
    ...
    try {
      await axios.delete(
        `https://absback1.vercel.app/api/section/${sectionToDelete._id}`
      );
      ...
      const sectionsResponse = await axios.get(
        "https://absback1.vercel.app/api/section"
      );
  ...
  const handleAddSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "https://absback1.vercel.app/api/section/create",
        formData,
        {
          headers: {
  ...
  const displaysections = (
    ...
    .map((section, index) => (
      <tr key={section._id}
        ...
        <td className="pl-4  text-center text-gray">
          {section.name}
          {section.isDefault && (
      ...
      <div className="">
        ...
        <div className="container mx-auto p-2 w-full mt-14 overflow-x-auto  border-gray-300 shadow-md font-sans max-w-5xl">
          <div className="flex items-center justify-between">
            <h1 className="text-xl font-bold font-sans mb-2 md:mb-0 text-orange-600">Hotel Sections</h1>
            ...
            <div className="p-1 text-center">
              ...
              <div className="mb-4 flex justify-center ">
                <input
                  ...
                  className="mr-4 p-4 border border-gray-300 rounded-md"
                />
                <label
