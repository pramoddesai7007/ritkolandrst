...
const Greetings = () => {
  ...
  const getGreetings = async () => {
    try {
      const response = await axios.get('https://absback1.vercel.app/api/greet/greet');
  ...
  const deleteGreet = async (greetId) => {
    try {
      const response = await axios.delete(`https://absback1.vercel.app/api/greet/greet/${greetId}`);
  ...
  const createGreet = async () => {
    ...
    try {
      const response = await axios.post('https://absback1.vercel.app/api/greet/greet', createGreetData);
  ...
  const updateGreet = async (greetId) => {
    ...
    try {
      const response = await axios.patch(`https://absback1.vercel.app/api/greet/greet/${greetId}`, updateGreetData);
