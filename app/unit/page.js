...
const UnitList = () => {
  ...
  useEffect(() => {
    const fetchUnits = async () => {
      try {
        const response = await axios.get('https://absback1.vercel.app/api/unit/units');
  ...
  const handleEditSubmit = async (e, updatedUnit) => {
    ...
    try {
      ...
      await axios.patch(`https://absback1.vercel.app/api/unit/units/${selectedUnit._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      await axios.delete(`https://absback1.vercel.app/api/unit/units/${selectedUnit._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://absback1.vercel.app/api/unit/units', { unit: newUnit });
  ...
  return (
    ...
    <h2 className="mb-4 text-lg font-semibold text-gray-800 dark:text-gray-400 text-left">Add Unit</h2>
