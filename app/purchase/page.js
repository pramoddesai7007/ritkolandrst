...
const PurchaseForm = () => {
    ...
    const fetchStockQty = async () => {
      try {
        const response = await axios.get(
          `https://absback1.vercel.app/api/purchase/purchase/stockQty?itemName=${formData.itemName}`
        );
  ...
  useEffect(() => {
    const fetchVendors = async () => {
      try {
        const response = await axios.get(
          "https://absback1.vercel.app/api/supplier/suppliers"
        );
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          "https://absback1.vercel.app/api/item/items"
        );
  ...
  useEffect(() => {
    const fetchGSTList = async () => {
      try {
        const response = await axios.get("https://absback1.vercel.app/api/gst/list");
  ...
  useEffect(() => {
    const fetchUnitList = async () => {
      try {
        const response = await axios.get(
          "https://absback1.vercel.app/api/unit/units"
        );
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.post(
        "https://absback1.vercel.app/api/purchase/purchase/savebill",
        data
      );
      ...
      if (parseFloat(data.total) > 0) {
        ...
        await axios.post("https://absback1.vercel.app/api/supplier/supplier/debit", {
          vendorName,
          amount: parseFloat(data.paidAmount),
        });
      } else {
        // If there is no paid amount, update the supplier's credit balance
        await axios.post("https://absback1.vercel.app/api/supplier/supplier/credit", {
          vendorName,
            ...
            <div>
              <Modal
                ...
                style={{
                  ...
                  content: {
                    width: "700px", // Set the width of the content
            ...
            <div>
              <Modal
                ...
                style={{
                  ...
                  content: {
                    width: "400px", // Set the width of the content
                    height: "400px", // Set the height of the content
                    margin: "auto", // Center the modal
                  },
                }}
              >
